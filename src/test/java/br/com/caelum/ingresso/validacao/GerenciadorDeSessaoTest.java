...
public class GerenciadorDeSessaoTest {
	...
	Filme filme = new Filme("Roque One", Duration.ofMinutes(120), "SCF-FI");
	LocalTime horario = LocalTime.parse("10:00:00");
	Sala sala = new Sala("");
	...
	Assert.assertFalse(gerenciador.cabe(new Sessao(horario.plusHours(1),
								filme, sala)));
	...
	Filme filme1 = new Filme("Roque One", Duration.ofMinutes(90), "SCF-FI");
	LocalTime dezHoras = LocalTime.parse("10:00:00");
	Sessao sessaoDasDez = new Sessao(dezHoras, filme1, sala);

	Filme filme2 = new Filme("Roque One", Duration.ofMinutes(120), "SCF-FI");
